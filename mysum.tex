...
For a set of Whole Slide Images (WSIs) from \mathcal{M} patients along with their respective labels, the input data is represented as: \begin{aligned}\mathbb{D}_{in}&=&\{C_1,C_2,...,C_M\},M&\geq&2,\end{aligned}
